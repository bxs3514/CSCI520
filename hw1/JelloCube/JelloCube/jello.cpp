...
void myinit()
{
	...
	boundingBoxRange = 2.0;
	preComputeInclinePara = 1 / sqrt(jello.a * jello.a + jello.b * jello.b + jello.c * jello.c);
...
#define LIGHTSETUP(i)\
  ...
  glEnable(GL_LIGHT##i)
	...
	//Update cube mass positions and velocities
	if (memcmp(jello.integrator, "RK4", sizeof(jello.integrator)) == 0)
	{
		RK4(&jello);
	}
	else
